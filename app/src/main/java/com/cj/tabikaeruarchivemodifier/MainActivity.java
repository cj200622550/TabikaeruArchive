package com.cj.tabikaeruarchivemodifier;
...
import com.cj.tabikaeruarchivemodifier.model.Event;
import com.cj.tabikaeruarchivemodifier.model.GameData;
import com.cj.tabikaeruarchivemodifier.model.GameData.OnLoadedListener;
import com.cj.tabikaeruarchivemodifier.model.Item;
import com.cj.tabikaeruarchivemodifier.model.Mail;
import com.cj.tabikaeruarchivemodifier.utils.AlbumsExporter;
import com.cj.tabikaeruarchivemodifier.utils.AlbumsExporter.OnProgressListener;
...
public class MainActivity extends AppCompatActivity implements OnLoadedListener, OnSeekBarChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (cacheDir == null) {
            Toasty.error(context, "共享存储当前不可用").show();
            finish();
            return;
        }
        try {
    ...
    private File findArchive(File dataDir) throws FileNotFoundException {
        ...
        throw new FileNotFoundException("没有找到存档文件");
    }
    ...
    private AlbumsExporter initAlbumsExporter() {
        ...
        File outputDir = new File(Environment.getExternalStoragePublicDirectory(
                Environment.DIRECTORY_PICTURES), "CJ");
        Log.d("TAG",pictureDir.toString());
        Log.d("TAG",outputDir.toString());
